...
cytokines = [
    {
        ...
        "kd": 0.001  # cytokine decay in medium 1/h
    }
]
...
cell_types_dict = [
    {"name": "default",
     "fraction": 1,
     "il2": {"R": 20000, "q": 0, "bc_type": "R_saturation", "Kc": 0.01},  # [Receptor number per cell, secretion in molecules/s]
     "internal_solver": "kineticSolver"
     },
    {"name": "changed",
     "fraction": 0.1,
     "il2": {"R": 20000, "bc_type": "R_saturation", "Kc": 0.01},
     "internal_solver": "kineticSolver"
     },
]
...
path = "/extra/brunner/thesis/static/niches/q_fraction_large/"
ext_cache = r"../q_fraction_ext_cache/"
path_kinetic = "/extra/brunner/thesis/kinetic/niches/q_fraction/"
IMGPATH = path + "images/"