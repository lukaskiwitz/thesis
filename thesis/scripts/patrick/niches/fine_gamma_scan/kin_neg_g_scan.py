...
import numpy as np
from parameters_neg_g_scan import cytokines, cell_types_dict, geometry, numeric, path_kinetic, ext_cache
...
for run in range(10):
    ...
    from parameters_neg_g_scan import numeric
    ...
    for frac in [0.25]:
        for v in [1/3,1/4,1/5,1/6,1/7,1/8,1/9]: #np.linspace(0, 20000.0, 1): #np.logspace(-1,1,3):
