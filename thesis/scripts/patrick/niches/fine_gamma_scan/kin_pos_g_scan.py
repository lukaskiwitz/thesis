...
import numpy as np
from parameters_pos_g_scan import cytokines, cell_types_dict, geometry, numeric, path_kinetic, ext_cache
...
for run in range(10):
    ...
    from parameters_pos_g_scan import numeric
    ...
    for frac in [0.25]:
        for v in [3,4,5,6,7,8,9]: #np.linspace(0, 20000.0, 1): #np.logspace(-1,1,3):
