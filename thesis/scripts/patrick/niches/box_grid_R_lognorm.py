...
def get_parameter_templates(ule):
    templates = {
        "R": PhysicalParameterTemplate(PhysicalParameter("R", 20000, to_sim=N_A ** -1 * 1e9)),
        "k_on": PhysicalParameterTemplate(PhysicalParameter("k_on", 540, to_sim=1e15 / 60 ** 2, is_global=True)),
        ...
        "kd": PhysicalParameterTemplate(PhysicalParameter("kd", 0.001, to_sim=1 / (60 * 2), is_global=True)),
        "fraction": PhysicalParameterTemplate(PhysicalParameter("fraction", 0, to_sim=1, is_global=True)),
        "sigma": PhysicalParameterTemplate(PhysicalParameter("sigma", 10000, to_sim=N_A ** -1 * 1e9, is_global=True)),
        ...
        "R_start": PhysicalParameterTemplate(PhysicalParameter("R_start", 0, to_sim=N_A ** -1 * 1e9)),

        "threshold": PhysicalParameterTemplate(PhysicalParameter("ths", 0.1, to_sim=1 / get_cc(ule))),
        "Kc": PhysicalParameterTemplate(PhysicalParameter("Kc", 0.1, to_sim=1 / get_cc(ule))),
