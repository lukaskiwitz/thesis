...
cell_types_dict = [
    {"name": "default",
     "fraction": 1,
     "il2": {"R": 20000, "q": 60, "bc_type": "R_saturation"},  # [Receptor number per cell, secretion in molecules/s]
     "internal_solver": "kineticSolver"
     },
    {"name": "changed",
     "fraction": 0.25,
     "il2": {"q": 60, "bc_type": "R_saturation"},
     "internal_solver": "kineticSolver"
     }
]
...
path_kinetic = "/extra/brunner/thesis/kinetic/saturation/R_lognorm/"
IMGPATH = path + "images/"