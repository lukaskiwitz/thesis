...
global_df2 = pd.read_hdf("/extra/brunner/thesis/kinetic/saturation/q_fraction_linear/" + 'global_df.h5', mode="r")
global_df2["IL-2_Kc"] = 0

cell_df2 = pd.read_hdf("/extra/brunner/thesis/kinetic/saturation/q_fraction_linear/" + 'cell_df.h5', mode="r")
cell_df2["IL-2_Kc"] = 0

global_df = pd.concat((global_df, global_df2))
cell_df = pd.concat((cell_df, cell_df2))
...
ax3 = sns.lineplot(x=x_axis, y="surf_c_std_norm", data=global_df.sort_values(by="time")[startingPoint:stoppingPoint].loc[global_df["IL-2_Kc"] == "$0.0$"],label="linear")
ax2 = sns.lineplot(x=x_axis, y="surf_c_std_norm", data=global_df.sort_values(by="time")[startingPoint:stoppingPoint].loc[global_df["IL-2_Kc"] == "$0.1$"],label="0.1")
ax1 = sns.lineplot(x=x_axis, y="surf_c_std_norm", data=global_df.sort_values(by="time")[startingPoint:stoppingPoint].loc[global_df["IL-2_Kc"] == "$0.05$"],label="0.05")




ax3.set(xlabel="time", ylabel="surf.c. std./mean surf.c.", title="c$_v$", yscale=yscale, xscale=xscale, ylim=ylim)
# plt.legend(bbox_to_anchor=(1.04,1), loc="upper left")
plt.legend(title="Kc")
fig.savefig("/home/brunner/Documents/Current work/05062020/" + "saturation_q_0.5" + ".png", bbox_inches='tight')
# plt.show()
#
...
# plt.show()
#
# R_mean_plotting = R_mean_plotting.sort_values(by="IL-2_Kc")
