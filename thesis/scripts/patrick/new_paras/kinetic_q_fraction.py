...
from thesis.scenarios.box_grid_q_fraction import setup
...
from thesis.scenarios.box_grid_q_fraction import get_parameter_templates
...
for v in [0.1]: #np.linspace(0, 20000.0, 1): #np.logspace(-1,1,3):
    for Treg_value in [0.25, 0.5, 0.75]:
        ...
        sim_parameters = [
            ...
            ParameterCollection("IL-2", [Treg_fraction(Treg_value)], field_quantity="il2"),
            ParameterCollection("IL-2", [c0(c0_value)], field_quantity="il2"),
