...
def get_parameter_templates(ule):
    templates = {
        ...
        "sec_sigma": PhysicalParameterTemplate(PhysicalParameter("sec_sigma", 5000, to_sim=N_A ** -1 * 1e9, is_global=True)),
        "Treg_sigma": PhysicalParameterTemplate(PhysicalParameter("Treg_sigma", 27000, to_sim=N_A ** -1 * 1e9, is_global=True)),
