...
for v in [1e-2,1e-1,1e1,1e2]: #np.linspace(0, 20000.0, 1): #np.logspace(-1,1,3):
    for frac in [0.25]:
        for hill_fac in [3]:
            ...
            sim_parameters = [
                ...
                ParameterCollection("IL-2", [c0(8e-12)], field_quantity="il2"), #8.637363
