...
cell_types_dict = [
    {"name": "Tnaive",
     "fraction": 0,
     "il2": {"R": 1e2, "q": 0, "bc_type": "linear"},  # [Receptor number per cell, secretion in molecules/s]
     "internal_solver": "kineticSolver"
     },
    {"name": "Tsec",
     "fraction": 0.25,
     "il2": {"R": 1e4, "q": 10, "bc_type": "linear"}, #"R_saturation"
     "internal_solver": "kineticSolver"
     },
    {"name": "Treg",
     "fraction": 0.75,
     "il2": {"R": 1e4, "q": 0, "bc_type": "linear"},
     "internal_solver": "kineticSolver"
     },
]
...
path_kinetic = hdd + "/brunner/thesis/kinetic/kin_large_halfed_hill_long/"
IMGPATH = path + "images/"