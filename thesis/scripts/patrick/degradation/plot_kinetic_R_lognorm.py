...
path = "/extra/brunner/thesis/kinetic/R_lognorm_large_gamma_scan_new_paras/"
...
# ax7.set(xlabel="time", ylabel="$c_v$", title="normed surf. std")#, yscale=yscale, xscale=xscale)
# # plt.legend(bbox_to_anchor=(1.04,1), loc="upper left")
# plt.legend()
# plt.show()
# fig.savefig("/home/brunner/Documents/Current work/05062020/" + "kin_R_cv" + ".png", bbox_inches='tight')
#
# exit()
