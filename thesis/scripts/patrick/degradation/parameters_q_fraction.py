...
geometry = {
    ...
    "rho": 5,  # cell radius
    "x_grid": 160,  # dimensions of the cell grid
    "y_grid": 160, # 160/180 for medium
    "z_grid": 160,# comment out for single cell layer
...
path = "/extra2/brunner/thesis/static/q_fraction_multi_medium/"
ext_cache = r"../q_fraction_medium_ext_cache/"
hdd = "/extra2" if os.path.exists("/extra2") else "/extra"
path_kinetic = hdd + "/brunner/thesis/kinetic/q_fraction_medium_degradation_scan/"
# path_kinetic = "/extra/brunner/thesis/kinetic/q_fraction_medium_g_10/"
IMGPATH = path + "images/"