...
def get_parameter_templates(ule):
    templates = {
        ...
        "q": PhysicalParameterTemplate(PhysicalParameter("q", 0, to_sim=N_A ** -1 * 1e9 *10/10)),
        ...
        "c0": PhysicalParameterTemplate(PhysicalParameter("c0", 11.90e-12, to_sim=1, is_global=True)),

        "threshold": PhysicalParameterTemplate(PhysicalParameter("ths", 0.1, to_sim=1 / get_cc(ule))),
        "Kc": PhysicalParameterTemplate(PhysicalParameter("Kc", 10.01, to_sim=1 / get_cc(ule))),
