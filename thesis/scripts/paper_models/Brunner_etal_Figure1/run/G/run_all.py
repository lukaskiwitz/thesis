...
conditions = []
# conditions.append({ScanAxis.ftreg: 0, ScanAxis.fth: 0.9, ScanAxis.fsec: 0.1, ScanAxis.v: [0., 0.7, 10], ScanAxis.R_per_cell: 5000.0})
conditions.append({ScanAxis.ftreg: 0, ScanAxis.fth: 0.9, ScanAxis.fsec: 0.1, ScanAxis.v: [0, 1, 50], ScanAxis.R_per_cell: 1e4})

# conditions = [
#     {ScanAxis.treg_cs_strength: [0, 1, 8], ScanAxis.ftreg: 0.025, ScanAxis.sigma: 1, ScanAxis.fsec: 0.1},
# ]
