...
cell_types_dict = [
     ...
     },
    {
     "name": "Th",
     "fraction": 0.9,
     "il2": {"R": 1e4, "q": 0, "bc_type": "patrick_saturation", "global_q": False},
     "misc": {"sigma": 1, # receptor distribution
              "gamma": 1,
              "states":[0,0,0,0,0,0],
              "pos_half_time": 1,
              "neg_half_time": 1,
