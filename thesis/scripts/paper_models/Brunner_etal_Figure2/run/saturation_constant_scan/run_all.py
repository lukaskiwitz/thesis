...
# CAREFUL, factor "* 7.437 * 1e-3" put into build_scans.py line 401!!!
conditions = [
    {ScanAxis.fth: 0.95, ScanAxis.fsec: 0.05, ScanAxis.KD: [-1, 1, 21]}, # CAREFUL, factor "* 7.437 * 1e-3" put into build_scans.py line 401!!!
]
