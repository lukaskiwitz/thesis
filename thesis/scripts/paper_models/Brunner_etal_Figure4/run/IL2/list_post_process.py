...
path_list = ['/extra2/brunner/paper_models/kinetics/Tsec_scan_7/positive_fig3E_finer_timesteps_fsec_scangamma_6_ftreg_0_fth_0.999',
             '/extra2/brunner/paper_models/kinetics/Tsec_scan_7/positive_fig3E_finer_timesteps_fsec_scangamma_7.5_ftreg_0_fth_0.999']
print("careful, path_list adjusted for missing runs!!!!!")
print("careful, path_list adjusted for missing runs!!!!!")
print("careful, path_list adjusted for missing runs!!!!!")
print("careful, path_list adjusted for missing runs!!!!!")
print("careful, path_list adjusted for missing runs!!!!!")
...
processes_per_sample = 5
TIME_INDEX = None

new_refine_paths = []
for entry in all_refine_paths:
    if "cell_df.h5" not in os.listdir(entry):
