...
for bc, linear in [("patrick_saturation",False)]:
    ...
    scan_container.add_single_parameter_scan([margin_def,x_def,y_def,z_def,bc_def(sec),bc_def(abs),linear_def,distance_def], scan_name="distance", dynamic_mesh=True)
