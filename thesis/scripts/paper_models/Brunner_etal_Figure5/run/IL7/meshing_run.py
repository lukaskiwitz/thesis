...
scan_kwargs = {ScanAxis.treg_cs_strength: 0.9, ScanAxis.ftreg: 0.0, ScanAxis.sigma: 1,ScanAxis.fsec: [0.05, 0.05, 1]}
...
compute_samples_points(scan_samples, scenario, old_path, [0, 1], ext_cache=ext_cache)