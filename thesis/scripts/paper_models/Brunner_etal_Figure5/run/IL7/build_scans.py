...
def update_state(sc, replicat_index):
    ...
    fractions_dict = sc.p.get_collection("fractions").get_as_dictionary(in_sim=True)
    ...
    cell_type = make_clusters(cell_grid_positions, apcs, fractions_dict, cluster_strengths, seed=replicat_index)
