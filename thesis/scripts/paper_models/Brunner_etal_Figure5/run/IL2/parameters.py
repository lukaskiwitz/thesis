...
cell_types_dict = [
     ...
     },
    {
     "name": "Th",
     "fraction": 0.95,
     "il2": {"R": 1.5e3, "q": 0, "bc_type": "patrick_saturation", "global_q": False, "pSTAT5": 0}, # "R_saturation"
     "clustering": {"strength": 0},
     "EC50": {"EC50": 0},
     ...
     },
    {
        "name": "Treg",
        "fraction": 0.0,
        "il2": {"R": 1e4, "q": 0, "bc_type": "patrick_saturation", "global_q": False, "pSTAT5": 0},
        "clustering": {"strength": 0},
        "EC50": {"EC50": 0},
        "R_start": {"R_start": 1e4},
        "misc": {"sigma": 0.5,
...
if mode == "sheet":
    ...
    geometry = {
        "randomize": "bridson",
        "margin": 10,  # margin around the cell grid
    ...
    numeric = {
        ...
        "cells_per_worker": 50,
        "max_pool_size": 1,
        "min_char_length": 0.7,  # mesh, smaller = finer
    ...
    geometry = {
        ...
        "distance": 12,  # distance between cell centers
        "rho": 5,  # cell radius
        "x_grid": 190,  # dimensions of the cell grid
        "y_grid": 190,
        "z_grid": 190,  # comment out for single cell layer
        "norm_area": 4 * np.pi * 5 ** 2
    }
    ...
    numeric = {
        ...
        "newton_atol": 1e-35,
        "newton_rtol": 1e-2,  # newton method relative tolerance
        "dofs_per_node": int(70000),
        "max_mpi_nodes": os.cpu_count(),
        "cells_per_worker": 50,
        "max_pool_size": 1,
        "min_char_length": 0.5,  # mesh, smaller = finer
...
model_name = "Tsec_Treg"
scan_name = "clustering_scan"

hdd = "extra2" if os.path.exists("/extra2") else "extra"
path = f"/{hdd}/{user}/{model_name}/{name}/{scan_name}/"
