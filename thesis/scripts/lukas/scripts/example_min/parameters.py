...
cell_types_dict = [
    {"name": "default",
     "fraction": 0,
     "il2": {"R": 4000, "q": 0, "Kc": 0.01, "amax": 0,"ths":0.01, "bc_type": "R_saturation"},
     "internal_solver": "RuleBasedSolver"
     },
    {"name": "sec",
     "fraction": 0.1,
     "il2": {"R": 4000, "q": 10, "Kc": 0.01, "amax": 1, "bc_type": "R_saturation"},
     "internal_solver": "RuleBasedSolver"
     },
    {"name": "abs",
     "fraction": 0.1,
     "il2": {"R": 20000, "q": 0, "Kc": 0.01, "amax": 100, "bc_type": "R_saturation"},
     "internal_solver": "RuleBasedSolver"
     }
]
...
numeric = {
    ...
    "dofs_per_node": 30000,#target degrees of freedom per mpi node for pde solving
