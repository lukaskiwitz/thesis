...
#        ]
#
#run({**p_d,**p_c,**p_il2,**p_il6,**p_sim},T,domainBC,"/extra/kiwitz/results_dirichletRun/secHigh/",extCache="/extra/kiwitz/extCache/")
#
...
#        ]
#
#run({**p_d,**p_c,**p_il2,**p_il6,**p_sim},T,domainBC,"/extra/kiwitz/results_dirichletRun/secLow/",extCache="/extra/kiwitz/extCache/")
...
path = "/extra/kiwitz/results_dirichletRun/"
...
for i,e in enumerate(l):  
    pass
    distPlot(path+e+"/",threshholds[i],cutoff=[10,10],imgPath="/home/kiwitz/plots_dirichletRun/",l=e)
